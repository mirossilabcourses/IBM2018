...
- Note: I just found a post from T.Seemann about assemblers *"Most de Bruijn  graph assemblers are highly tuned to a specific coverage ~100 and a specific errors rate <1%."*
